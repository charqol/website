...
<main>
	...
	<div class="relative h-screen py-10 flex content-center items-center justify-center">
		<div
			class="absolute top-0 w-full h-full bg-center bg-cover bg-fixed"
			style="background-image: url('/chatbot-soln.jpg');"
		>
	...
	<main class="p-4 py-10 bg-[#f7f6f6] sm:p-6 md:p-8 lg:p-10 space-y-6 sm:space-y-8 md:space-y-10">
		{#each data.sections as section}
			<ScrollAnimation>
				...
				>
					<div
						class="absolute inset-0 bg-gray-600 sm:rounded-l-lg sm:w-2 sm:h-full w-full h-2 rounded-t-lg rounded-l-none"
					></div>
